...
class RowIncrementHandlerTest {
    ...
    @Test
    void shouldUpdateAllCorrespondingRows() {
        ArrayList<Cell> updatedCells = new ArrayList<>();
        List<List<Cell>> updatedGrid = List.of(
                List.of(Cell.builder().row(0).column(0).value(0).build(), Cell.builder().row(0).column(1).value(0).build(), Cell.builder().row(0).column(2).value(0).build()),
                List.of(Cell.builder().row(1).column(0).value(2).build(), Cell.builder().row(1).column(1).value(2).build(), Cell.builder().row(1).column(2).value(2).build()),
                List.of(Cell.builder().row(2).column(0).value(2).build(), Cell.builder().row(2).column(1).value(2).build(), Cell.builder().row(2).column(2).value(2).build())
        );
        List<Cell> expectedUpdatesCells = List.of(Cell.builder().row(1).column(0).value(2).build(), Cell.builder().row(1).column(1).value(2).build(), Cell.builder().row(1).column(2).value(2).build());

        this.rowIncrementHandler.handle(1, 1, this.grid, updatedCells);
    ...
    void shouldInvokeNextRegisteredGridUpdaterWithUpdatedGridAndCells() {
        this.rowIncrementHandler.setNext(columnIncrementHandler);
        List<Cell> expectedUpdatesCells = List.of(Cell.builder().row(1).column(0).value(2).build(), Cell.builder().row(1).column(1).value(2).build(), Cell.builder().row(1).column(2).value(2).build());
        List<List<Cell>> updatedGrid = List.of(
                List.of(Cell.builder().row(0).column(0).value(0).build(), Cell.builder().row(0).column(1).value(0).build(), Cell.builder().row(0).column(2).value(0).build()),
                List.of(Cell.builder().row(1).column(0).value(2).build(), Cell.builder().row(1).column(1).value(2).build(), Cell.builder().row(1).column(2).value(2).build()),
        ...
        this.rowIncrementHandler.handle(1, 1, this.grid, new ArrayList<>());

        assertTrue(this.grid.containsAll(updatedGrid));
        verify(columnIncrementHandler, times(1)).handle(1, 1, updatedGrid, expectedUpdatesCells);
    }
}